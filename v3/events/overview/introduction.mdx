...
| ----------------------------------- | -------- | ------------------------------------- | ---------------------------------------------- |
| `/api/events_info/get_event_fields` | GET      | Available event fields                | Discover searchable fields for each event type |
| `/api/events_search`                | POST     | Full-text search with event filtering | Find events matching specific criteria         |
| `/api/health`                       | GET      | API health status                     | Monitor API availability                       |
| `/api/subscription`                 | GET/POST | Subscription information              | Check available events and usage limits        |
