...
<Tabs>
  <Tab title="Standard">
    **Plan ID**: `v3_local_news_nlp`
    ...
    <Check>Make up to 250,000 API calls monthly</Check>
  ...
  <Tab title="Embeddings">
    **Plan ID**: `v3_local_news_nlp_embeddings`
    ...
    <Check>Make up to 25,000 API calls monthly</Check>
...
| ----------------------- | -------- | ---------- | ------------- |
| **API Limits**          |
| Monthly API Calls       | 250,000  | 25,000     | 250,000       |
| Rate Limit (calls/sec)  | 5        | 5          | 5             |
| Max Sources per Request | 2,000    | 2,000      | 2,000         |
| Historical Data Access  | 30 days  | 30 days    | 30 days       |
| **Core Features**       |
| Article Metadata        | ✓        | ✓          | ✓             |
...
<Warning>
  To prevent service interruptions, implement rate limiting in your application
  to stay within the 5 requests per second limit.
</Warning>
