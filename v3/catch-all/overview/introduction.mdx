...
<AccordionGroup>
  ...
  <Accordion title="Dynamic schemas" icon="flask">
    ...
    **Variable fields:**
    ...
    <Tip>
      See [Understanding dynamic schemas](/v3/catch-all/overview/dynamic-schemas) 
  ...
  <Accordion title="Customizable extraction" icon="wand-magic-sparkles">
    ...
    **Custom enrichments** define what data to extract:
    ...
    <Tip>
      Use the [`POST /catchAll/initialize`](/v3/catch-all/endpoints/initialize-job) endpoint to get suggested validators and 
  ...
  <Accordion title="Date range controls" icon="calendar">
    ...
    <Tip>
      Use the [`POST /catchAll/initialize`](/v3/catch-all/endpoints/initialize-job) 
  ...
  <Accordion title="Asynchronous operation" icon="clock">
    ...
    Track detailed progress through the [`steps`](/v3/catch-all/endpoints/get-job-status#response-steps) 
  ...
  <Accordion title="Job continuation" icon="rotate">
    ...
    [`POST /catchAll/continue`](/v3/catch-all/endpoints/continue-job) to process more 
