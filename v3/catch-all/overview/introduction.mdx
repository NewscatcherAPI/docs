...
<AccordionGroup>
  ...
  <Accordion title="Asynchronous operation" icon="clock">
    ...
    Partial results become available during the `enriching` stage as validation 
    completes in batches. The `progress_validated` field tracks how many 
    candidate clusters have been processed.
  </Accordion>
</AccordionGroup>
