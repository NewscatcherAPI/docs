...
<AccordionGroup>
  <Accordion title="Dynamic schemas" icon="wand-magic-sparkles">
    ...
    **Variable fields:**
    ...
    <Tip>
      See [Understanding dynamic schemas](/v3/catch-all/overview/understanding-dynamic-schemas) for integration patterns.
    </Tip>
...
<CardGroup cols={2}>
  ...
  >
    ...
    icon="code"
    href="/v3/catch-all/overview/understanding-dynamic-schemas"
  >
