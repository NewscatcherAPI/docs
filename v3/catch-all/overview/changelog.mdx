...
- [`POST /catchAll/initialize`](/v3/catch-all/endpoints/initialize-job) — Get
  validator, enrichment, and date range suggestions.
- Enhanced [`POST /catchAll/submit`](/v3/catch-all/endpoints/create-job) — Now
  accepts date ranges, validators, and enrichments.
- Enhanced [`GET /catchAll/jobs/user`](/v3/catch-all/endpoints/list-user-jobs) —
