...
Use the CatchAll community node to integrate CatchAll API directly into your n8n
workflows.
...
| ---------- | ------------------------------ | ----------------------------- |
| `Submit` | Create a new CatchAll job      | POST /catchAll/submit         |
| `Status` | Check job processing progress  | GET /catchAll/status/{job_id} |
| `Pull`   | Retrieve completed job results | GET /catchAll/pull/{job_id}   |
