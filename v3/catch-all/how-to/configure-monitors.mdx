...
constraints may limit result variety across monitor runs.

**Best practice**: Use open-ended queries (e.g., "AI company acquisitions" instead 
...
```typescript
    ...
    console.log(`Updated: ${response.monitorId}`);
```
  </Tab>
</Tabs>
