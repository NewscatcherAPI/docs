...
See [Create job endpoint](/web-search-api/api-reference/endpoints/jobs/create-job) for all enrichment types.
...
- [Initialize endpoint](/web-search-api/api-reference/endpoints/jobs/initialize-job)
- [Create job endpoint](/web-search-api/api-reference/endpoints/jobs/create-job)
