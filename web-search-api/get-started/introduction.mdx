...
<AccordionGroup>
  ...
  <Accordion title="Date range controls" icon="calendar">
    Specify custom date ranges for web search, or let the system determine 
    ...
    <Tip>
      Use the [`POST /catchAll/initialize`](/web-search-api/api-reference/jobs/initialize-job) 
...
- **Event monitoring**: Topic-specific events with structured output
