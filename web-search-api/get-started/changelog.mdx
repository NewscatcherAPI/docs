...
- [`POST /catchAll/initialize`](/web-search-api/api-reference/endpoints/jobs/initialize-job) — Get
  validator, enrichment, and date range suggestions.
- Enhanced [`POST /catchAll/submit`](/web-search-api/api-reference/endpoints/jobs/create-job) — Now
  accepts date ranges, validators, and enrichments.
- Enhanced [`GET /catchAll/jobs/user`](/web-search-api/api-reference/endpoints/jobs/list-user-jobs) —
...
- [`POST /catchAll/continue`](/web-search-api/api-reference/endpoints/jobs/continue-job) — Continue
  completed job with higher limit.
- [`PATCH /catchAll/monitors/{monitor_id}`](/web-search-api/api-reference/endpoints/monitors/update-monitor)
...
- **Progress tracking**: Status endpoint now returns detailed
  [`steps`](/web-search-api/api-reference/endpoints/jobs/get-job-status#response-steps) array showing
...
- [`GET /catchAll/jobs/user`](/web-search-api/api-reference/endpoints/jobs/list-user-jobs) now
  returns only user-created jobs, excluding repeated monitor jobs.
- Monitor responses use
  [`run_info`](/web-search-api/api-reference/endpoints/monitors/get-monitor-results#response-run-info)
...
- [`GET /catchAll/monitors`](/web-search-api/api-reference/endpoints/monitors/list-monitors) — List all
  monitors for your API key.
- [`POST /catchAll/monitors/{monitor_id}/enable`](/web-search-api/api-reference/endpoints/monitors/enable-monitor)
  — Enable a disabled monitor.
- [`POST /catchAll/monitors/{monitor_id}/disable`](/web-search-api/api-reference/endpoints/monitors/disable-monitor)
...
- [`GET /catchAll/jobs/user`](/web-search-api/api-reference/endpoints/jobs/list-user-jobs) — List all
  jobs created with your API key.
- [`GET /catchAll/monitors/pull/{monitor_id}`](/web-search-api/api-reference/endpoints/monitors/get-monitor-results)
...
- [`POST /catchAll/monitors/create`](/web-search-api/api-reference/endpoints/monitors/create-monitor) —
  Create scheduled monitor.
- [`GET /catchAll/monitors/{monitor_id}/jobs`](/web-search-api/api-reference/endpoints/monitors/list-monitor-jobs)
  — List monitor jobs.
...
- [`POST /catchAll/submit`](/web-search-api/api-reference/endpoints/jobs/create-job) — Create jobs
  with natural language queries.
- [`GET /catchAll/status/{job_id}`](/web-search-api/api-reference/endpoints/jobs/get-job-status) —
  Check processing status.
- [`GET /catchAll/pull/{job_id}`](/web-search-api/api-reference/endpoints/jobs/get-job-results) —
