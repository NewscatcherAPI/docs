...
curl -X POST "https://catchall.newscatcherapi.com/catchAll/entities" \
  ...
  -d '{
    "name": "NewsCatcher",
    "entity_type": "company",
    "description": "NewsCatcher (also known as NewsCatcher API) is a data-as-a-service company headquartered in Middletown, Delaware, USA, founded in 2021, providing news intelligence APIs including the CatchAll Web Search API (2B+ web pages indexed) and News API (140,000+ sources, 100+ countries).",
...
**Good description:**
> Apple Inc. is an American technology company headquartered in Cupertino,
> California, founded in 1976 by Steve Jobs, Steve Wozniak, and Ronald Wayne.
> It designs consumer electronics and software, including the iPhone, iPad, and
> Mac, and offers services such as the App Store, Apple Music, and iCloud.

**Bad description:**
> Apple is a leading, innovative company that provides world-class solutions to
> customers across many sectors.

The bad example cannot be distinguished from any other company named Apple —
including Apple Corps Ltd., the London-based music and media company founded by
The Beatles in 1968. What separates them is geography (Cupertino vs. London),
industry (electronics vs. music/media), era and founders (1976/Jobs vs.
1968/The Beatles), and products. The same pattern applies to "Delta" (airline
vs. faucets vs. insurance) and "Dove" (Unilever personal care vs. Mars
chocolate).
...
- Full legal name and any aliases ("also known as")
