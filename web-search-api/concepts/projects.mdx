...
to separate work by use case, team, or client â€” and to share that work with
...
- **At creation time** â€” include `project_id` in the request body of any
  create endpoint for jobs, monitors, or datasets.
- **Post-hoc** â€” use the [Add resources](/web-search-api/api-reference/projects/add-resource)
...
projects â€” they are shared across the entire organization.
...
Returns resource counts grouped by type and status â€” useful for dashboards
...
By default, deleting a project unassigns its resources â€” they continue to exist
