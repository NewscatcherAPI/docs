...
**Main use case:** Search, extract, and monitor any real-world event or fact
...
> Track these 20 competitors for the past month. [attach CSV]

---

### Fundraising

Finds confirmed funding announcements — pre-seed through Series C and beyond
— across any geography, stage, and industry vertical. Returns structured event
records, not raw links or article summaries.
