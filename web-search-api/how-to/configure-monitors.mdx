...
<Warning>
  **Minimum interval** depends on your subscription. For trials and PAYG is **24 hours**. But for the smallest paid subscription it is **12 hours**.
</Warning>
...
<Tabs>
 <Tab title="Hourly (If your plan allows it)">
    - `"every hour"`
    - `"every 6 hours"`
    - `"every 12 hours"`
  </Tab>
...
| ---------------------------- | --------------- | ------------------------ |
| `"every day at 12 PM UTC"`   | `0 12 * * *`    | âœ… Daily                 |
| `"every Monday at 9 AM EST"` | `0 9 * * 1`     | âœ… Weekly                |
| `"every 12 hours"`           | `0 */12 * * *`  | âœ… Hourly (If your plan allows it)                |
