...
description:
  Add Postman Collections into your own Workspace for easy NewsCatcher News API
  usage experience
---

## Authentication

Before proceeding with Postman integration, be sure to register at
[app.newscatcherapi.com](https://app.newscatcherapi.com/) and get an API Key.
...
[Documentation page](https://docs.newscatcherapi.com/api-docs/endpoints) on each
endpoint and use different combinations of filters and parameters to get the
