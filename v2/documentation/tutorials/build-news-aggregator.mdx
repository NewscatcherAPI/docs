...
description: This guide takes you through the process of building a news aggregator with the NewsCatcher news API.
---
...
Check out this nifty [crypto news aggregator](https://crypto-news.newscatcherapi.com/) we made.

![](/images/news-aggregator.gif)

Did we miss any outlets you need? Reach out to us at [team@newscatcherapi.com](mailto:team@newscatcherapi.com), we'll add it without breaking a sweat.