...
[`v2/search`](https://docs.newscatcherapi.com/api-docs/endpoints/search-news)
and
[`v2/latest_headlines`](https://docs.newscatcherapi.com/api-docs/endpoints/latest-headlines)
endpoints.
