...
So this article: [https://www.techradar.com/news/tesla-model-x-vs-tesla-model-y](https://www.techradar.com/news/tesla-model-x-vs-tesla-model-y) is transformed into a structured JSON object:
