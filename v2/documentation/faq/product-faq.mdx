...
By incrementing the `page`parameter you will be able to get all the results. Go check [this example](/v2-code-snippets/scroll-through-pages).

How to get more than 10,000 articles per call?
--------------------------------------------------

You can do it only by breaking down your search into small parts by using the `published_date` or other parameters. You can check [this example](/v2-code-snippets/10000-articles).
...
Our `rank`parameter is based on the [Majestic Million rank](https://blog.majestic.com/welcome-to-majestic-million/) system. The smaller the rank, the more trustful is the website domain.
