...
Be mindful of your [account type](https://newscatcherapi.com/news-api#news-api-pricing) while making calls. Different types have different limits on the total API calls you can make, the number of calls/second, and the publication dates of the articles. Here's a table for quick reference:
...
<Info>
You can check your account type in the [dashboard](https://app.newscatcherapi.com/dashboard/)
</Info>