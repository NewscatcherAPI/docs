...
description: API endpoints of NewsCatcher News API
---

_There's a lot that can be done using our news API, and we are constantly working on new endpoints/functions that might make your job easier for you. That being said, these are the most commonly used methods:_
...
<Card href="v2/api-reference/search/search-for-specific-news-articles" icon="caret-right">
Search News
</Card>
...
<Card href="v2/api-reference/latest_headlines/get-latest-news-articles" icon="caret-right">
Latest Headlines
</Card>
### Sources `/sources`
...
<Card href="v2/api-reference/sources/get-top-news-sources-supported-by-newscatcher" icon="caret-right">
Sources
</Card>
