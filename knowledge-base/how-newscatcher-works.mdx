...
description: Learn more about what it takes to deliver online-published news to your API response object
---
...
In order to find relevant results only - among the more than a million news articles that we index daily - the API makes a call to [ElasticSearch](https://www.elastic.co/elasticsearch/) clusters.
