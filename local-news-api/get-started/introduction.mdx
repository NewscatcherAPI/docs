...
<Note>
  ...
  Reference](/local-news-api/api-reference/endpoints/search/search-articles-post).
</Note>
...
5. Dive into the [API reference](/local-news-api/api-reference/endpoints/search/search-articles-post) for detailed endpoint
