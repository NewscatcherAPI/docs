---
title: News API quickstart guide
sidebarTitle: Quickstart
description:
  This guide will help you make your first API call to NewsCatcher News API
...
- An API key for NewsCatcher News API (obtained from your account manager)
...
Now that you've made your first calls to the NewsCatcher News API and
...
2. Check out our [API Reference](/news-api/api-reference/endpoints/search/search-articles-post) to learn about all available
   endpoints and parameters.
3. Learn how to
   [Implement pagination](/news-api/how-to/paginate-large-datasets) to
   handle large datasets.
4. Dive deeper into the
   [NLP features](/news-api/guides-and-concepts/nlp-features) to extract
