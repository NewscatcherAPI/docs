...
<Note>
  ...
  headlines](/news-api/api-reference/latest-headlines/retrieve-latest-headlines-post)
...
3. Explore
   [News API v3 endpoints](/news-api/api-reference/authors/search-articles-by-author-get)
