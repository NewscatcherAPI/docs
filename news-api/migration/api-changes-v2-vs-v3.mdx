...
<Note>
  ...
  Reference](/news-api/api-reference/authors/search-articles-by-author-get).
</Note>
...
<Warning>
  ...
  sources](/news-api/api-reference/sources/retrieve-sources-get).
</Warning>
...
3. Check the version-specific API Reference for detailed parameter and response
   field documentation:
   - [v3 API Reference](/news-api/api-reference/search/search-articles-post)
