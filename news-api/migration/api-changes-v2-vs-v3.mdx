...
<Note>
  ...
  Reference](/news-api/api-reference/endpoints/authors/search-articles-by-author-get).
</Note>
...
<Warning>
  ...
  sources](/news-api/api-reference/endpoints/sources/retrieve-sources-get).
</Warning>
...
<Note>
  ...
  tags](/news-api/guides-and-concepts/custom-tags).
</Note>
...
[Libraries](/news-api/get-started/libraries) documentation.
...
1. Review the [Migration guide](/news-api/migration/migration-guide) for
...
3. Check the version-specific API Reference for detailed parameter and response
   field documentation:
   - [v3 API Reference](/news-api/api-reference/endpoints/search/search-articles-post)
...
5. For advanced features:
   ...
   - Explore [Custom tags](/news-api/guides-and-concepts/custom-tags)
   - Understand
