...
Custom Tags in News API lets you filter and classify articles using your
...
system is now ready and accessible via News API by your API key. All articles
...
Custom Tags are integrated into the News API and available across the
following endpoints:
