...
In the context of the NewsCatcher News API, advanced querying techniques
...
- [Proximity search with NEAR](/news-api/how-to/search-with-near)
- [API Reference](/news-api/api-reference/overview/introduction)
