...
[language codes in News API](/news-api/api-reference/overview/enumerated-parameters#language-lang-and-not-lang).
...
[How to search by entity](/news-api/how-to/search-by-entity).
