---
title: Errors
description: Quick reference guide for common errors in News API
---
...
might encounter while using the News API:
...
| 499         | Unknown status code   | Client-side errors that do not fit standard HTTP status codes.                                          | Check for missing fields or incorrect parameters. Follow the [API Reference](/news-api/api-reference/endpoints/search/search-articles-get). |
...
[Error handling](/news-api/troubleshooting/error-handling) guide.
