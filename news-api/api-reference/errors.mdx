...
| 499         | Unknown status code   | Client-side errors that do not fit standard HTTP status codes.                                          | Check for missing fields or incorrect parameters. Follow the [API Reference](/news-api/api-reference/search/search-articles-get). |
