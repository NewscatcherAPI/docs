...
[guide](/news-api/guides-and-concepts/working-with-historical-data) for
...
3. Review the [API documentation](/news-api/api-reference/endpoints/search/search-articles-post) for the correct format.
...
<Info>
  ...
  Tracing
  guide](/news-api/troubleshooting/request-tracing-correlation-ids).
</Info>
...
- [Rate limits and quotas](/news-api/api-reference/overview/rate-limits)
- [NewsCatcher status page](https://status.newscatcherapi.com)
- [How to report bugs](/news-api/troubleshooting/report-bugs)
