...
3. Review the [API documentation](/news-api/api-reference/search/search-articles-post) for the correct format.
...
- [Rate limits and quotas](/news-api/api-reference/rate-limits)
