...
1. **Check documentation**: Review the [API Reference](/news-api/api-reference/endpoints/search/search-articles-post) to
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="flask"
    href="/news-api/api-reference/endpoints/search/search-articles-post"
  >
...
- [API error codes](/news-api/api-reference/overview/errors)
