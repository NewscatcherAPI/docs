...
[`/aggregation_count`](/news-api/api-reference/aggregation/get-aggregation-count-by-interval-get)
...
- [Aggregation count endpoint](/news-api/api-reference/aggregation/get-aggregation-count-by-interval-get)
- [Working with historical data](/news-api/guides-and-concepts/working-with-historical-data)
